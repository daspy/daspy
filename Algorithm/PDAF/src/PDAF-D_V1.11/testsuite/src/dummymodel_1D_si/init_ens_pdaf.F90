!$Id: init_ens_pdaf.F90 1099 2011-08-17 14:15:30Z lnerger $
!BOP
!
...
!
! As different filter methods are implemented in
! this example, this routine calls the initialization
...
! within PDAF. This routine just calls the perticular
